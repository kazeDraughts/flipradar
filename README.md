...
Rebuy : lecture des tarifs publics de rachat, en centimes EUR, avec vérification de l'identifiant, du titre, des indicateurs de reprise disponible et de la cohérence des prix entre champs et variantes. Pour le neuf, le calcul utilise A1 (« comme neuf »). Ce n'est ni le prix de vente du magasin, ni le bon d'achat, ni un historique de ventes conclues. Le montant de base PS5 Slim a été vérifié via le questionnaire public le 25/09/2026, sans ajouter de produit au panier. Les tarifs sont relus à chaque scan, sans abonnement. Les accessoires doivent être complets ; le questionnaire final, l'état réel et les conditions d'éligibilité peuvent modifier la reprise. Une réserve de transport sortant est conservée par prudence.

Pour l'occasion, le titre doit annoncer explicitement un bon, très bon ou excellent état. Une mention générique « reconditionné » ou « grade A » ne suffit pas. Le calcul exige une grille Rebuy A1–A4 complète et décroissante, puis utilise son tarif le plus bas (A4), sans assimiler les grades de vendeurs différents. La réserve de risque est de 15 % au minimum, contre 5 % pour le neuf. Un défaut repéré dans le titre ou la description bloque l'alerte. Cette approche n'est pas un contrôle physique : A4 n'est pas un minimum garanti, et un problème de batterie, d'authenticité ou d'accessoires peut entraîner une baisse ou un refus de reprise.

Les [conditions Rebuy](https://www.rebuy.fr/legal/terms-and-conditions) visent les consommateurs finaux et les quantités usuelles de particuliers. L'éligibilité d'une activité d'achat-revente, les justificatifs et les conditions applicables doivent être confirmés auprès de Rebuy avant achat. Le radar ne garantit pas ce débouché et n'effectue aucune transaction.
